    ...
    return(
      <ul style={{color: 'black'}}>
        <div style={{width: '25%', textAlign: 'left', display: 'inline-block', fontFamily: 'Cabin Sketch', fontSize:'36px'}}>
          <img style={{width:'10%', marginTop: '2%', marginRight: '2%'}} src="https://image.flaticon.com/icons/svg/59/59708.svg" />
        ...
        <div style={{width: '50%', textAlign: 'center', display: 'inline-block', fontFamily: 'Zeyada', fontSize:'36px', color: '#1F8CE3'}}>
          <li><img style={{maxHeight: '50px', display:"inline", paddingRight: '10px'}} src="https://image.flaticon.com/icons/svg/59/59576.svg" /></li>
          <li><NavLink to='/add/goal' style={{textDecoration: 'none'}}>make new goal</NavLink></li>
          <li><img style={{maxHeight: '50px', display:"inline", paddingLeft: '10px'}} src="https://image.flaticon.com/icons/svg/59/59684.svg" /></li>
        </div>
